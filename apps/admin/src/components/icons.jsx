...
const I = {
  ...
  menu: [<path key="a" d="M4 6h16" />, <path key="b" d="M4 12h16" />, <path key="c" d="M4 18h16" />],
  chevronUp: [<path key="a" d="m18 15-6-6-6 6" />],
  chevronLeft: [<path key="a" d="m15 18-6-6 6-6" />],
  chevronRight: [<path key="a" d="m9 18 6-6-6-6" />],
  arrowUp: [<path key="a" d="M12 19V5" />, <path key="b" d="m5 12 7-7 7 7" />],
  arrowDown: [<path key="a" d="M12 5v14" />, <path key="b" d="m19 12-7 7-7-7" />],
  sliders: [<line key="a" x1="4" x2="4" y1="21" y2="14" />, <line key="b" x1="4" x2="4" y1="10" y2="3" />, <line key="c" x1="12" x2="12" y1="21" y2="12" />, <line key="d" x1="12" x2="12" y1="8" y2="3" />, <line key="e" x1="20" x2="20" y1="21" y2="16" />, <line key="f" x1="20" x2="20" y1="12" y2="3" />, <line key="g" x1="1" x2="7" y1="14" y2="14" />, <line key="h" x1="9" x2="15" y1="8" y2="8" />, <line key="i" x1="17" x2="23" y1="16" y2="16" />],
  layers: [<path key="a" d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z" />, <path key="b" d="m22 12.09-9.17 4.18a2 2 0 0 1-1.66 0L2 12.09" />, <path key="c" d="m22 17.09-9.17 4.18a2 2 0 0 1-1.66 0L2 17.09" />],
  checkCircle: [<circle key="a" cx="12" cy="12" r="10" />, <path key="b" d="m9 12 2 2 4-4" />],
  xCircle: [<circle key="a" cx="12" cy="12" r="10" />, <path key="b" d="m15 9-6 6" />, <path key="c" d="m9 9 6 6" />],
  ban: [<circle key="a" cx="12" cy="12" r="10" />, <path key="b" d="m4.9 4.9 14.2 14.2" />],
  flag: [<path key="a" d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1Z" />, <line key="b" x1="4" x2="4" y1="22" y2="15" />],
  star: [<polygon key="a" points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />],
  tag: [<path key="a" d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z" />, <circle key="b" cx="7.5" cy="7.5" r=".5" fill="currentColor" />],
  upload: [<path key="a" d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />, <polyline key="b" points="17 8 12 3 7 8" />, <line key="c" x1="12" x2="12" y1="3" y2="15" />],
  code: [<polyline key="a" points="16 18 22 12 16 6" />, <polyline key="b" points="8 6 2 12 8 18" />],
  hash: [<line key="a" x1="4" x2="20" y1="9" y2="9" />, <line key="b" x1="4" x2="20" y1="15" y2="15" />, <line key="c" x1="10" x2="8" y1="3" y2="21" />, <line key="d" x1="16" x2="14" y1="3" y2="21" />],
  sparkles: [<path key="a" d="m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z" />, <path key="b" d="M19 3v4" />, <path key="c" d="M17 5h4" />],
  qr: [<rect key="a" x="3" y="3" width="7" height="7" rx="1" />, <rect key="b" x="14" y="3" width="7" height="7" rx="1" />, <rect key="c" x="3" y="14" width="7" height="7" rx="1" />, <path key="d" d="M14 14h3v3h-3z" />, <path key="e" d="M20 14v3" />, <path key="f" d="M14 20h7" />],
  network: [<rect key="a" x="9" y="2" width="6" height="6" rx="1" />, <rect key="b" x="2" y="16" width="6" height="6" rx="1" />, <rect key="c" x="16" y="16" width="6" height="6" rx="1" />, <path key="d" d="M12 8v4" />, <path key="e" d="M5 16v-2h14v2" />],
  history: [<path key="a" d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" />, <path key="b" d="M3 3v5h5" />, <polyline key="c" points="12 8 12 12 15 14" />],
